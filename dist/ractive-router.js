(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("ractive-router", [], factory);
	else if(typeof exports === 'object')
		exports["ractive-router"] = factory();
	else
		root["ractive-router"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _crossroads = __webpack_require__(4);
	...
	exports.default = _ractive2.default.extend({
	    ...
	    oninit: function oninit() {
	        ...
	        Object.keys(this.routesConfig).map(function (pattern) {
	            ...
	            var routeObject = _crossroads2.default.addRoute(pattern, function () {
	                var container = this.find('main.routeContainer');
	                //
	                var values = arguments;
	                var pathParamNames = _crossroads2.default.patternLexer.getParamIds(pattern);
	        ...
	        _crossroads2.default.bypassed.add(function () {
	            _hasher2.default.replaceHash('404');
	        });
	    },
	    onrender: function onrender() {
	        ...
	        if (!location.hash) {
	            ...
	            if (pattern) {
	                _hasher2.default.replaceHash(pattern);
	            }
	        }
	    }
	});
...
;
//# sourceMappingURL=ractive-router.js.map